    ...
    <section className="mt-12">
      ...
      <div className="mt-3 flex gap-3 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {recentFarms.map((farm) => (
          <Link
            className="glass glass-card glass-interactive group w-56 shrink-0 rounded-field p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-ink/20 hover:shadow-elev-3 focus-visible:ring-2 focus-visible:ring-ink/20"
