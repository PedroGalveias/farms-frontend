...
export default function BentoOverview({
  ...
  return (
    <Reveal className="mt-5 grid items-stretch gap-4 sm:grid-cols-[2fr_1fr]">
      ...
      <div className="glass glass-card flex min-h-[120px] flex-col justify-center gap-2 rounded-card px-5 py-4">
        ...
        <div className="flex flex-wrap gap-1.5">
          {mostWanted.slice(0, 3).map((key) => (
            <button
              className="glass-chip rounded-chip px-3 py-1.5 text-sm font-bold text-pine transition-colors hover:bg-pine/10 focus-visible:ring-2 focus-visible:ring-pine/40 active:scale-[0.97]"
              key={key}
