...
export default function BentoOverview({
  ...
  return (
    <Reveal className="mt-5 grid grid-cols-2 gap-4 sm:grid-cols-4 sm:[grid-auto-rows:158px]">
      ...
      <div className="glass glass-card flex flex-col justify-center rounded-[22px] px-5 py-4">
      ...
      <div className="glass glass-card flex flex-col justify-center gap-2 rounded-[22px] px-5 py-4">
