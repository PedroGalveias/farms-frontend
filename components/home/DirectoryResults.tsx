...
export default function DirectoryResults({
  ...
  return (
    <section className="mt-8">
      {/* The toolbar stays available while browsing; this informational count
          deliberately remains in the document flow so it never covers cards. */}
      <div className="-mx-2 flex flex-wrap items-baseline justify-between gap-3 rounded-field bg-paper px-2 py-2">
